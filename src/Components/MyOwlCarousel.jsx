...
export default function MyOwlCarousel() {
   const OwlList = [
     ...
     },
     {
       ...
       movieRating: "9.3",
       description:
         "A 30-episode series showcasing the various events during the life of Umar Ibn Al-Khattab from his pre-Islamic days till his assassination.",
     ...
     },
     {
       ...
       movieRating: "9.3",
       description:
         "Prophet Joseph is an Iranian Islamic television series. It is based on the Islamic account of Joseph from Quran and Islamic traditions.",
     ...
     },
     {
       ...
       movieRating: "9.3",
       description:
         "A 17-episode series showcasing the various events during the life of Hazrat Esa.",
     ...
     },
     {
       ...
       movieRating: "9.3",
       description:
         "Mokhtarnameh is based on the life of Al-Mukhtar, who led a rebellion against the Umayyad Caliphate",
     ...
     },
     {
       ...
       movieRating: "9.3",
       description:
         "Ashab E Kahf depicts the story of the Seven Sleepers, according to the Quran.",
       cast: "Dariush Arjmand, Vishka Asayesh, Mohammad-Reza, Mehdi Fat'hi",
       genre: "Biography, drama, religion, history, serial",
       tag: "Historical Biopic, Faith, Spiritual Exploration",
     },
     ...
     },
     {
       ...
       play: "video/Movie/Suleiman",
       tagLine: "Top Rated",
       name: "Hazrat Sulaiman",
       rating: "16+",
       movieRating: "9.3",
       description:
         "A film delves into Muslim family life, religious ceremonies, and the Five Pillars of Islam, emphasizing the significance of family and faith in Muslim communities.",
       cast: "Samer Ismail, Ghassan Massoud, Ghanem Zrelli",
       genre: "Biography, Drama, Religion, History, Serial",
       tag: "Historical Biopic, Faith, Spiritual Exploration",
     },
